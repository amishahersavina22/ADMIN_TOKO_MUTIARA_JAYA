    ...
    <div class="card-body">
        <div class="row">
            <div class="col-8">
                      ...
                      <div class="col-sm-9" style="margin-left:-50px;">
                      <input type="date"  id="tanggal" name="tanggal" class="form-control border-0 border-bottom ps-2">
                                </div>
                         </div>
                         <div class="mb-3 row">
                      ...
                      <div class="col-sm-9" style="margin-left:-50px;">
                      <input type="text"  id="jumlah" name="jumlah" class="form-control border-0 border-bottom ps-2">
                                </div>
                         </div>
                         <div class="mb-3 row">
