...
$id =$_GET['id'];
$mebel = mysqli_query($conn, "SELECT * FROM mebel WHERE id='$id'");
$data =  mysqli_fetch_array($mebel);
?>
?>
...
<div class="container-fluid px-4">
   <h1 class="mt-4">Update Data Barang Mebel</h1>
   <ol class="breadcrumb mb-4">
       ...
       <li class="breadcrumb-item active" style="color:#ffff;">Update Data Mebel</li>
    </ol>
    <form action="prosesmebel.php" method="POST" enctype="multipart/form-data">
<div class="card">
    <div class="card-header">
    <span class="h-5 my-2"><i class="fa-solid fa-to-square"></i>Update Data</span>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <input type="hidden"  id="id" name="id"  value="<?=$data['id']?>">
                      ...
                      <?php
                        $barangmebel=["NAPOLLY","JEPARA","OLYMPIC"];
