...
if (isset($_POST['simpan'])){
    ...
    mysqli_query($conn,"INSERT INTO elektronik VALUES (null,'$nama_barang','$kode_barang','$merek','$harga','$jumlah_stok')");

    echo 
    "<script> alert('Data barang elektronik berhasil disimpan');
    ...
    mysqli_query($conn," UPDATE elektronik SET 
