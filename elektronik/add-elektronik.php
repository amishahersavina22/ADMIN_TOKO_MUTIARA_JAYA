...
<div class="container-fluid px-4">
   <h1 class="mt-4">Tambah Data Barang Elektronik</h1>
   <ol class="breadcrumb mb-4">
       <li class="breadcrumb-item"><a href="../index.php" style="color:#ffff;">HOME</a></li>
       <li class="breadcrumb-item"><a href="mebel.php" style="color:#ffff;">Elektronik</a></li>
       <li class="breadcrumb-item active" style="color:#ffff;">Tambah Data Elektronik</li>
    </ol>
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-8">
                      ...
                      <div class="col-sm-9" style="margin-left:-50px;">
                      <input type="text"  id="jumlah_stok" name=jumlah_stok"harga" class="form-control border-0 border-bottom ps-2">
                                </div>
                         </div>
                    </div> 
                 </div>
