...
<div class="container-fluid px-4">
    <h1 class="mt-4" style="color:#ffff;"> DATA  KESELURUHAN STOK  ELEKTRONIK</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="../index.php" style="color:#ffff;">HOME</a></li>
        <li class="breadcrumb-item active" style="color:#ffff;">Data Barang ELEKTRONIK</li>
    </ol>
<div class="card">
 ...
 <i class="fa-solid fa-square-plus"></i>Tambah Data</a>  
    ...
    <div class="card-body">
     <table class="table table-hover" id="datatablesSimple">
        ...
        <?php
            $no =1;
            $queryelek =mysqli_query($conn, "CALL GetTotalStok1()");
